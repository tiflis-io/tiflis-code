...
import type { ErrorMessage, PongMessage, ResponseMessage, HeartbeatAckMessage } from '../../protocol/messages.js';
...
export interface MessageHandlers {
  ...
  'supervisor.cancel': MessageHandler;
...
export class MessageRouter {
  ...
  /**
   * Sends a heartbeat acknowledgment with workstation uptime.
   */
  sendHeartbeatAck(socket: WebSocket, requestId: string, timestamp: number): void {
