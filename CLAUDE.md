...
| watchOS App   | `TiflisCodeWatch`                    | watchOS        | Swift, SwiftUI, HTTP Polling | 🚧 WIP        |
| Android App   | `TiflisCodeAndroid`                  | Android        | Kotlin, Jetpack Compose      | 🚧 WIP        |
...
> **Note:** watchOS and Android apps are in active development and not yet ready for production use.
...
> 📖 See [docs/MOBILE_APP_LOGIC.md](docs/MOBILE_APP_LOGIC.md#watchos-app-wip) for detailed architecture

Native Apple Watch companion with HTTP Polling (WebSocket blocked on watchOS 9+), voice commands, and WatchConnectivity sync.
